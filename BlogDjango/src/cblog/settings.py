...
DATABASES = {
    'default': {
        ...
        'NAME': 'database1', # databa
        'USER': 'admin', # database master username in RDS is written here
        'PASSWORD': config('PASSWORD'),
        'HOST': 'awsproject-rds.c7uygsi0g2ds.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awsproject-sergen-blog' # please enter your s3 bucket name
