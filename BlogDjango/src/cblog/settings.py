...
DATABASES = {
    'default': {
        ...
        'NAME': 'xxxx', # database name in RDS is written here
        'USER': 'xxxx', # database master username in RDS is written here
        'PASSWORD': config('PASSWORD'),
        'HOST': 'xxxxxxxx',  # database endpoint is written here
